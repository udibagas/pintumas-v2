                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        {app.description && (
                          <p className="text-yellow-100 mt-1">{app.description}</p>
                        )}
      ...
      <div style={{ backgroundColor: '#011629' }} className="text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <Link href="/contact">
              <Button size="lg" variant="outline" className="bg-yellow-500/20 border-yellow-500/30 text-yellow-100 hover:bg-yellow-500/30">
                Hubungi Kami
              </Button>
            </Link>
          </div>
